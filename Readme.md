...
This guide was created by originally [Felix Geisendörfer](http://felixge.de/) and is
licensed under the [CC BY-SA 3.0](http://creativecommons.org/licenses/by-sa/3.0/)
license. I have made some updates to reflect my own personal views (yes, that is all they are). You are encouraged to fork this repository and make adjustments according to your preferences.
